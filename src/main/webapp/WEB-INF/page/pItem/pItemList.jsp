	...
	<form class="layui-form">
		...
		<div style="margin-top: 1%">
			<div class="layui-inline">
				<input type="text" id="iName" value="" placeholder="请输入课程名称"
			...
			<shiro:hasPermission name="sys:teacher:save">
				<div class="layui-inline">
					<a class="layui-btn layui-btn-normal userAdd_btn">添加课程</a>
				</div>
			</shiro:hasPermission>
            ...
            function() {
                ...
                table
                    .render({
                        id : 'userList',
                        elem : '#userList',
                        url : ctx + '/sys/getPItemList?pId='+pId //数据接口
                        ,
                        limit : 10//每页默认数
                        ,
                        limits : [ 10, 20, 30, 40 ],
                ...
                table.on('tool(userList)', function(obj) {
                    ...
                    if (obj.event === 'del') {
                        layer.confirm('真的删除行么', function(index) {
                            $.ajax({
                                url : ctx + '/sys/delPItemById?id='+data.iId,
                                type : "get",
                                success : function(d) {
                                    if (d.code == 0) {
                        ...
                        layer.open({
                            ...
                            title : "编辑章节信息",
                            area : [ '400px', '300px' ],
                            content : ctx + "/sys/editPItem?id="+data.iId
                        })
                    }
...
//                      title:"添加课程信息",
//                      area: ['380px', '460px'],
//                      content:ctx+"/sys/addPItem", //这里content是一个普通的String
//                  })
...
//              })
                $(".userAdd_btn").click(function() {
					var index = layui.layer.open({
						title : "添加课程",
						type : 2,
						content : ctx + "/sys/addPItem?pId="+pId,
                                    ...
                                    .confirm(
                                        ...
                                        function(
                                            ...
                                            $
                                                .ajax({
                                                    url : ctx
                                                        + '/sys/delPItemById?carouselStr='+userStr,
                                                    type : "get",
                                                    success : function(
                                                        d) {
                                                        if (d.code == 0) {
