...
<body class="childrenBody">
	<form class="layui-form" style="width: 80%;" id="aaf">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				...
				<p id="uploadError"></p>
				<input type="hidden" lay-verify="imgurl" name="tdCode" id="newsImg" value=""/>
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				...
				<img class="layui-upload-img" id="preview1" style="width: 150px;margin-top: 5px">
				<p id="uploadError1"></p>
				<input type="hidden" lay-verify="imgurl" name="background" id="newsImg1" value=""/>
			</div>
		</div>
	...
	<script type="text/javascript" src="${ctx }/page/vcode/addcodes.js"></script>
</body>
</html>