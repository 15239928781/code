layui.config({
	...
	var form = layui.form,table = layui.table;
		...
		table.render({
		    ...
		    ,cols: [[ //表头
              ...
              ,{field:'rPrices', title: '金额(元)'}
              ,{field:'rNum', title: '赠送积分数量'}
		  ...
		  table.on('tool(test)', function(obj){
		    ...
		    if(obj.event === 'del'){
		      layer.confirm('真的删除行么?', function(index){
		    	  $.ajax({
		    		  url:ctx+'/reward/delete?id='+data.rId,
		    		  type : "get",
		    		  success : function(d){
		    			  if(d.code==0){
		      ...
		      layer.open({
		    	  ...
		    	  title:"编辑积分使用规则",
		    	  area: ['380px', '360px'],
		    	  content:ctx+"/reward/editReward?id="+data.rId //这里content是一个普通的String
		      })
		    }
		  });
	...
	$(".carouselAdd_btn").click(function(){
		layer.open({
	    	  ...
	    	  title:"添加积分使用规则",
	    	  area: ['380px', '360px'],
	    	  content:ctx+"/reward/addReward", //这里content是一个普通的String
	      })
	})
