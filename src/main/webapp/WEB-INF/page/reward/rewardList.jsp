...
<body class="childrenBody">
	...
	<blockquote class="layui-elem-quote list_search">
		<shiro:hasPermission name="reward:reward:save">
			<div class="layui-inline">
				<a class="layui-btn layui-btn-normal carouselAdd_btn" ><i class="layui-icon">&#xe608;</i>   添加积分奖励规则</a>
			</div>
		</shiro:hasPermission>
		<shiro:hasPermission name="reward:reward:delete">
			<div class="layui-inline">
	...
	<script type="text/javascript" src="${ctx}/page/reward/rewardList.js"></script>
	<script type="text/html" id="barEdit">
		<shiro:hasPermission name="reward:reward:update">
