...
<body class="childrenBody">
	...
	<blockquote class="layui-elem-quote list_search">
		<shiro:hasPermission name="integralUse:integralUse:save">
			<%--<div class="layui-inline">
				<a class="layui-btn layui-btn-normal carouselAdd_btn" ><i class="layui-icon">&#xe608;</i>   添加积分规则</a>
			</div>--%>
		</shiro:hasPermission>
		<shiro:hasPermission name="integralUse:integralUse:delete">
			<div class="layui-inline">
	...
	<!-- 数据表格 -->
	<table id="integralUseList" lay-filter="test"></table>
	
	<script type="text/javascript" src="${ctx}/layui/layui.js"></script>
	<script type="text/javascript" src="${ctx}/page/integralUse/integralUseList.js"></script>
	<script type="text/html" id="barEdit">
		<shiro:hasPermission name="integralUse:integralUse:update">
