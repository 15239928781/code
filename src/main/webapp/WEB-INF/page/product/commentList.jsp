	...
	<blockquote class="layui-elem-quote news_search">
		<form class="layui-form">
			<div style="margin-top: 1%">
				<div class="layui-inline">
					<input type="text" id="createTimeStart"
						...
						placeholder="评论时间(开始)" value="">
				</div>
				<div class="layui-inline">
					<input type="text" id="createTimeEnd" class="layui-input userName"
						name="createTimeEnd" placeholder="评论时间(结束)" value="">
				</div>
			...
			<div class="category" id="category">
				<span>好评${goodNum}个</span>
				<span>中评${mediumNum}个</span>
				<span>差评${poorNum}个</span>
			</div>
	</blockquote>
	</form>
						...
						function() {
							...
							table
									.render({
										id : 'userList',
										elem : '#userList',
										url : ctx + '/sys/getCommentList?pId='+${pId} //数据接口
										,
										limit : 10//每页默认数
										,
										limits : [ 10, 20, 30, 40 ],
