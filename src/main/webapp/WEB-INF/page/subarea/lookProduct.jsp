...
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
		<form class="layui-form">
			...
			<div style="margin-top: 1%">
				...
				<div class="layui-inline">
					<a class="layui-btn layui-btn-normal productAdd_btn">批量添加商品</a>
				</div>
				&lt;%&ndash;<shiro:hasPermission name="sys:product:save">
					<div class="layui-inline">
						<a class="layui-btn layui-btn-normal userAdd_btn">添加商品</a>
					</div>
				</shiro:hasPermission>&ndash;%&gt;
				&lt;%&ndash;<shiro:hasPermission name="sys:product:delete">
					<div class="layui-inline">
			...
			--%>	<a class="layui-btn layui-btn-danger batchDel">批量移除</a>
	...
	<script type="text/html" id="barEdit">
		<%--<shiro:hasPermission name="sys:product:update">--%>
			<a class="layui-btn layui-btn-xs" lay-event="edit">设置价格</a>
	<%--	</shiro:hasPermission>--%>
						...
						function() {
							...
							table
									.render({
										id : 'userList',
										elem : '#userList',
										url : ctx + '/subarea/getProductList/'+sbId //数据接口
										,
										limit : 10//每页默认数
										,
										limits : [ 10, 20, 30, 40 ],
							...
							table.on('tool(userList)', function(obj) {
								...
								if (obj.event === 'del') {
                                   ...
                                   layui.layer.open({
                                        ...
                                        type : 2,
                                       area: ['380px', '580px'],
                                        content : ctx + "/subarea/editSubareaProduct?pId="
                                            + data.pId+"&sbId="+sbId, //这里content是一个普通的String
															...
															.confirm(
																	...
																	function(
																		...
																		$
																				.ajax({
																					url : ctx
																							+ '/subarea/delSubareaProducts?userStr='
																							+ userStr+"&sbId="+sbId,//接口地址
																					type : "get",
																					success : function(
																							d) {
																						if (d.code == 0) {
                                        ...
                                        if (data.length > 0) {
                                            if(data.length>1){
                                                ...
                                                var index = layui.layer.open({
                                                    title : "查看分区商品",
                                                    type : 2,
                                                    content : ctx + "/subarea/lookProduct/"+userStr+"/"+sbId,
                                                    success : function(layero, index) {
