...
<form class="layui-form" style="width: 80%;" id="auf" enctype="multipart/form-data">
	...
	<input type="hidden" name="sbId" value="${userStr}">

	<%--<div class="layui-form-item">
		<label class="layui-form-label">分区</label>
		<div class="layui-inline" >
			<select name="" class="" id="sbId"  lay-verify="required" lay-filter="test">
	...
	<div class="layui-form-item">
		...
		<%--<label class="layui-form-label" id="ppt" style="display: none">素材PPT</label>
		<div class="layui-inline" id="ppt2" style="display: none">
			<button type="button" class="layui-btn" id="onePicUpload2"><i class="layui-icon"></i>上传文件</button><br />
			<p id="uploadError2"></p>
		</div>--%>
	...
	<div class="layui-form-item" id="ppt" style="display: none">
		...
		                <i class="layui-icon">&#xe67c;</i>请选择PPTX/PDF
		          </button>
...
--%>
		...
		    </div>    
<%--
	    <input type="text" id="imgUrls" name="pIsgroup" style="display: none;" class="layui-input">
--%>
	<%--<input type="hidden" id="imgUrls" name="pIsgroup" class="layui-input userName" value="">--%>
...
//			MultipartFile file 对应，layui默认就是file,要改动则相应改动
	...
	<input type="hidden" id="iTime" name="pIsgroup" class="layui-input userName"
		   value="">
	<div id="uploader">
            ...
            var uploader = $("#uploader").pluploadQueue({
                ...
                init: { //监听函数
                    ...
                    FileUploaded: function(uploader,file,responseObject) { //当队列中的某一个文件上传完成后触发
                       ...
                       // lastJsonstring = lastJsonstring.substring(0,lastJsonstring.length - 1);
...
<script type="text/javascript" src="${ctx }/page/subarea/addProduct.js"></script>
</body>
</html>