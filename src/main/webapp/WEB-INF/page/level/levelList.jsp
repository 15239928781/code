...
<body class="childrenBody">
	...
	<blockquote class="layui-elem-quote list_search">
		<shiro:hasPermission name="level:level:save">
			<div class="layui-inline">
				<a class="layui-btn layui-btn-normal carouselAdd_btn" ><i class="layui-icon">&#xe608;</i>   添加会员等级</a>
			</div>
		</shiro:hasPermission>
		<shiro:hasPermission name="level:level:delete">
			<div class="layui-inline">
	...
	<script type="text/javascript" src="${ctx}/page/level/levelList.js"></script>
	<script type="text/html" id="barEdit">
		<shiro:hasPermission name="level:level:update">
