...
<body class="childrenBody">
	<form class="layui-form" style="width: 80%;" id="aaf">
		...
		<input type="hidden" name="cIsshow" value="1">
		<div class="layui-form-item">
			<label class="layui-form-label">分类名称</label>
			<div class="layui-input-block">
				<input type="text" class="layui-input userName"
					lay-verify="required" placeholder="请输入分类名称" name="cName" value="">
			</div>
		</div>
		...
		<label class="layui-form-label">分类图片</label>
		  <div class="layui-input-block">
			...
			<p id="uploadError"></p>
			<input type="hidden" lay-verify="imgurl" name="cImage" id="newsImg" value=""/>
		  </div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
	...
	<script type="text/javascript" src="${ctx }/page/category/addCategory.js"></script>
</body>
</html>