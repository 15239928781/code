...
<form class="layui-form" style="width: 80%;" id="auf" enctype="multipart/form-data">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block">
			...
			<!-- /KindEditor -->
			<textarea id="editor_id" name="companyDesc" style="width:800px;height:600px;" class="textArea"></textarea>
		</div>
	</div>
	<div class="layui-form-item">
		<div class="layui-input-block">
...
<script type="text/javascript" src="${ctx }/page/company/addCompany.js"></script>
</body>
</html>